...
class HistoriaPag extends StatelessWidget{
  ...
  final Historia hist = Historia(
    ...
    origemCorrida: 'Com a rápida evolução de Annes, surgiu a necessidade de um desenvolvimento rápido e prático de várias nações. No entanto, não era tão fácil conseguir progresso de maneira acelerada sozinho, assim, a ideia uma competição automobilística surgiu e seu prêmio final seria amparo tecnológico. Desse modo, surgiu Caos Crusier, uma corrida intercontinental na qual o país do piloto vencedor ganha apoio de Annes com suas carências em âmbito teconlógico.',
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        ...
        title: hist.construirTitleAppBar(title: hist.textosPag[4].toUpperCase()),
        centerTitle: true,
      ),
      body: Center(
        child: Container(
          ...
          child: Center(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  hist.construirTitulo(title: hist.textosPag[0]),
